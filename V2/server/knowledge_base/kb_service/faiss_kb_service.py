...
#
#     def do_init(self):
#         self.vector_name = self.vector_name or self.embed_model.replace
...
#     faissService.add_doc(KnowledgeFile("+煤矿安全培训规定.docx", "test"))
#     faissService.delete_doc(KnowledgeFile("README.md", "test"))
#     faissService.do_drop_kb()
#     print(faissService.search_docs("煤矿安全规程是什么？"))
#     docs = faissService.search_docs("煤矿安全规程是什么？")
